...
function oneGameClickListener(e, leagueName, docId){
	...
	if(targetId == "cmdSubmit"){	//TODO: chack that nubers are not minus	
			...
			if(two || x || one){// check if user already submit form for this game
				...
				.then(function(querySnapshot){
					querySnapshot.forEach(function(doc){
						...
						formExists = true;
						console.log(doc.data());// TODO: put on screen the form Details from db same as "settings"
					});
