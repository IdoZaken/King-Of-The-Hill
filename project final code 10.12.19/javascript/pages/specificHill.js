let specificHill = function($container, hillId , hillLeague, hillName){
	$container.html(        //addint html and a back botton
		"<div id = 'specificHill'>"+
			...
			"</br>"+
			"<main>"+
				"<div id = 'king' class = 'containerRating'>"+
					"<div class = 'icon'></div>"+
					"<div class = 'rank'>Rank: <span>king</span></div>"+
					"<div class = 'name'>name</div>"+
					"<div class = 'score'>Score: <span></span></div>"+
				"</div>"+
				"<br/>"+
				"<div id = 'prince' class = 'containerRating'>"+
					"<div class = 'icon'></div>"+
					"<div class = 'rank'>Rank: <span>prince</span></div>"+
					"<div class = 'name'>name</div>"+
					"<div class = 'score'>Score: <span></span></div>"+
				"</div>"+
				"<br/>"+
				"<div id = 'knight' class = 'containerRating'>"+
					"<div class = 'icon'></div>"+
					"<div class = 'rank'>Rank: <span>knight</span></div>"+
					"<div class = 'name'>name</div>"+
					"<div class = 'score'>Score: <span></span></div>"+
				"</div>"+
				"<br/>"+
				"<div id = 'userRank' class = 'containerRating'>"+
					"<div class = 'icon'></div>"+
					"<div class = 'rank'>Your Rank: <span></span></div>"+
					"<div class = 'name'>name</div>"+
					"<div class = 'score'>Score: <span></span></div>"+
				"</div>"+
			"</main>"+
	...
	collRef.get().then(function(querySnapshot){
		...
		.then(function(querySnapshot){
		    ...
		    querySnapshot.forEach(function(doc){		//for every one chack the rank and update on screen
				...
				if(counter == 1){//king
					$('#king .name').text("Name: "+doc.get("Name"));
					$('#king .score span').text(doc.get("Score"));
				}
				else if(counter == 2){//prince
					$('#prince .name').text("Name: "+doc.get("Name"));
					$('#prince .score span').text(doc.get("Score"));
				}
				else if(counter == 3){//knight
					$('#knight .name').text("Name: "+doc.get("Name"));
					$('#knight .score span').text(doc.get("Score"));
				}
				if(doc.get("UserId") == currentUserId){
					$('#userRank .name').text("Name: "+doc.get("Name"));
					$('#userRank .score span').text(doc.get("Score"));
					$('#userRank .rank span').text(counter);
