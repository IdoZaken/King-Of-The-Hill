let admin = function($container){
    ...
    .then(function(idTokenResult) {
        if(idTokenResult.claims.admin){     //if user is admin then run this page else return to home page
            //admin screen html
            $container.html(
                "<div id = 'admin'>"+
                    "<h1>Admin</h1>"+
                    "<div id = 'adminContent'>"+
                        "<div id = 'addAdmin'>"+
                            "<fieldset>"+
                                "<label for = 'newAdminEmail'>Enter email to add new admin</label><br/>"+
                                "<input type = 'email' id = 'newAdminEmail' placeholder = 'New Admin Email' />"+
                                "<button id = 'cmdAddNewAdmin'>Add Admin</button>"+
                            "</fieldset>"+
                        "</div><hr/><hr/"+
                        "<div id = 'createRound'>"+
                        "<fieldset>"+
                            ...
                            "<fieldset>"+
                                ...
                                "<select id = 'homeTeam' >"+
                                    ...
                                    "<option id = 'Second League'>Hapoel Kfar Saba</option>"+
                                    ...
                                    "<option id = 'Top League'>Sektzia Nes Tziona</option>"+
            ...
            $("#cmdAddNewAdmin").click(adminClickListener);
...
let adminClickListener = function(e){
    ...
    else if(targetId == "cmdAddNewAdmin"){  //add new admin by his mail
        const newAdminEmail = $('#newAdminEmail').val();    //get new admin email
        const addAdminRole = firebase.functions().httpsCallable('addAdminRole');    //referens to the function in server
        addAdminRole({email: newAdminEmail}).then(result => {   //call to function in server and wait to respond
            console.log(result);
